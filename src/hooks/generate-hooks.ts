...
// Post-pre-flight: the agent has full function context from the scan.
// Allow all reads - if the prompt is strong enough, the agent won't re-read.
// If it does (e.g. for exact whitespace in Edit), blocking is counterproductive.
