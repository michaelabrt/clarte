...
import { getDefaultScanPaths, getDefaultScanPathsForLanguage, getLanguageConfig } from "../core/snapshot/scan-paths";
import type { DetectedContext, Language } from "../core/types";
