...
import { applyBudget, applyCharBudget } from "../steer/context/budget";
import { trimSnapshotToChars, renderSnapshot } from "../core/snapshot/snapshot";
import type { CodeSnapshot, ContextSection, SnapshotEntry } from "../core/types";
